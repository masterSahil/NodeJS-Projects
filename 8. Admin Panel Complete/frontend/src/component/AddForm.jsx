      ...
      <main className="flex-1 h-full overflow-y-auto p-4 lg:p-8">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1.5">Configure user profile details and system access permissions.</p>
          </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6 lg:p-8 transition-shadow hover:shadow-md">
              <div className="flex items-center gap-2 mb-6 pb-4 border-b border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">Select the organizational access level for this user.</p>
                </div>
              </div>
