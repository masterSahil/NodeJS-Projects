    ...
    <div className="min-h-screen flex items-center justify-center p-4 font-sans text-gray-900 bg-linear-to-br from-slate-50 via-gray-100 to-blue-50 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md w-full bg-white/70 backdrop-blur-xl rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-white/60 p-8 sm:p-10 transition-all duration-300">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-600 text-white mb-5 shadow-lg shadow-blue-500/30">
            {/* Mail Icon */}
        ...
        <form onSubmit={handleSendOtp} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={isLoading}
                className="w-full pl-10 pr-4 py-2.5 bg-gray-50/50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl text-sm font-medium shadow-sm shadow-blue-500/30 transition-all active:scale-[0.98] mt-4 flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
        ...
        <div className="mt-8 text-center text-sm">
          <button
            onClick={() => navigate('/')}
            className="text-gray-500 hover:text-gray-800 font-medium inline-flex items-center justify-center transition-colors focus:outline-none"
          >
